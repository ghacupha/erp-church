...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './placeholder.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IPlaceholder, defaultValue } from 'app/shared/model/placeholder.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLACEHOLDER_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PLACEHOLDERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PLACEHOLDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLACEHOLDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLACEHOLDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLACEHOLDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLACEHOLDER actions', async () => {
      const expectedActions = [
        {
